    ...
    return (
        <div className="min-h-screen bg-transparent text-slate-900 pt-24 pb-12 sm:pt-32 sm:pb-20 font-sans">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {/* Search Bar */}
                <ScrollReveal className="flex justify-center items-center mb-16 relative" delay={0.2}>
                    <input
                        className="bg-zinc-200 text-zinc-600 font-mono ring-1 ring-zinc-400 focus:ring-2 focus:ring-rose-400 outline-none duration-300 placeholder:text-zinc-600 placeholder:opacity-50 rounded-full px-4 py-2 shadow-md focus:shadow-lg focus:shadow-rose-400 dark:shadow-md dark:shadow-purple-500 w-full max-w-md"
                        autoComplete="off"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {filteredBlogs.map((post, index) => (
                            <ScrollReveal 
                                ...
                                className="h-full"
                            >
                                <article className="group bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-200 transition-all duration-300 flex flex-col h-full backdrop-blur-md hover:shadow-xl hover:border-brand-accent/30">
